...
//cp.execSync('msgmerge -U --no-wrap -w 10 i18n/po/de.po i18n/po/template.pot');

let sourceText = fs.readFileSync('i18n/po/template.pot', {encoding: 'utf8'});
let targetText = fs.readFileSync('i18n/po/de.po', {encoding: 'utf8'});
...
fs.writeFileSync('i18n/po/de.po', targetText);
